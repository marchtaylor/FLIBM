...
lfq2 <- lfqModify(lfq, bin_size = 2, years = 1998:1999)
lfq2 <- lfqRestructure(lfq2)
...
# make MLZ class
lfq3 <- lfqModify(lfq, aggregate = "year", bin_size = 2)
...
new.dataset@vbt0 <- ta2t0(par = lfq3$par, Lrecr = 0, plot = FALSE)$t0
plot(new.dataset)
...
plot(yrs, FMs+0.7, t = "o", ylim = c(0,2))
...
```{r}
lfq2 <- lfqCohort(lfq = lfq2, n.per.yr = 1)
